...
//               {openImageModel && (
//                 <div className="fixed  top-0 left-0 w-full h-full inset-0
//                  bg-black bg-opacity-50 flex items-center justify-center z-50">
//                   <div className="bg-gray-800 p-4 rounded-lg w-[400px] text-white">
//                     <div className="mb-4 pb-3 flex justify-between items-center">
//                       <h3 className="text-lg font-semibold text-white mb-4">
//                         Image Preview
//                       </h3>
//                       <X
