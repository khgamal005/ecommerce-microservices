...
import { HeartIcon, Search, User } from "lucide-react";
        ...
        <div className="flex-1 flex justify-end">
          <div className="flex items-center gap-6">
            ...
            <span className="text-sm font-medium">Hello,</span>
              <span className="text-sm font-semi">sign in</span>
            </Link>

            {/* User Greeting */}
          </div>
          <div className="flex items-center gap-2">
            <Link href='/whishlist' className="text-sm font-medium"><HeartIcon /></Link>
          </div>
        </div>
