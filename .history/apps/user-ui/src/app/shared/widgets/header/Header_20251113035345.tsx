...
const Header = () => {
  ...
  const { user, isLoading, logout } = useUser(); // Assuming your hook provides logout function
          ...
          <div className="w-[90%] mx-auto py-4">
            ...
            <div className="mt-4 pt-4 border-t">
              <div className="text-sm text-gray-600">
                <span>Hello, {user ? user.name : 'welcome to Easy Shop'}</span>
              </div>
            </div>
          </div>
        </div>
