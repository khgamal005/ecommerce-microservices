...
const HeaderBottom = () => {
  ...
  const links = [
    ...
    { title: "Shops", href: Routes.Shops },{ title: "Become a Seller", href: Routes.BecomeSeller },
  ];
  ...
  return (
    ...
    >
      <div
        className={`w-[80%] m-auto flex items-center justify-between h-12 relative ${
          sticky ? "pt-3" : "py-0"
        }`}
      >
        {/* all dropdown-menu */}
        <div
          className={`absolute left-0 w-[260px] bg-[#3489FF] shadow-md ${
            sticky && "-mt-2"
        ...
        {show && (
          <div
            className={`absolute left-0 w-[260px] h-[400px] bg-[#f5f5f5] shadow-md mt-1.5  ${
