...
import { getUser, loginUser, refreshToken, resendRegistrationOtp, resetUserPassword, userForgetPassword, userRegistration, verifyUserForgetPassword, verifyUserRegistration } from '../controller/auth.controller';
...
router.post("/logout", refreshToken);
