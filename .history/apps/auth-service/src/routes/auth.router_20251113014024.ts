...
import { getUser, loginUser, resendRegistrationOtp, resetUserPassword, userForgetPassword, userRegistration, verifyUserForgetPassword, verifyUserRegistration } from '../controller/auth.controller';
...
router.post('/loged-in-user', isAuthenticated,getUser);
