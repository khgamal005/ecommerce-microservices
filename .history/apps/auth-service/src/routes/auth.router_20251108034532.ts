...
import { loginUser, resetUserPassword, userRegistration, verifyUserRegistration } from '../controller/auth.controller';
...
*/
router.post('/forget-password', userForgetPasswor);
